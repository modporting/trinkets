...
public class TestTrinket extends TrinketItem implements TrinketRenderer<BipedEntityRenderState, BipedEntityModel<BipedEntityRenderState>> {

	private static final Identifier TEXTURE = Identifier.of(TrinketsTest.MOD_ID, "textures/entity/trinket/hat.png");
	private TrinketModel model;
	...
	@Override
	public void render(ItemStack stack, SlotReference slotReference, BipedEntityModel contextModel, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, BipedEntityRenderState state, float limbAngle, float limbDistance, float headYaw, float headPitch) {
		TrinketModel model = this.getModel();
